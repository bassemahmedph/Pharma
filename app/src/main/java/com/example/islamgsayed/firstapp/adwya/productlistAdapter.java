...
import com.example.islamgsayed.firstapp.Cart.CartItem;
import com.example.islamgsayed.firstapp.R;
import com.example.islamgsayed.firstapp.Cart.StaticConfig;
...
//        mydialog.addContentView(R.layout.);


//        viewHolder.ITEM_FORM.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                TextView textView,textView1;
//                textView=(TextView) v.findViewById(R.id.sender);
//                textView1= v.findViewById(R.id.content);
//                textView.setText(products.get(viewHolder.getAdapterPosition()).getName());
//                //textView1.setText(products.get(viewHolder.getAdapterPosition()).getName());
//
//
//                mydialog.show();
//

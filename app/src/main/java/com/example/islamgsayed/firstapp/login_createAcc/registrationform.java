    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  Btnregister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent activityChangeIntent = new Intent(registrationform.this, registertwo.class);
                registrationform.this.startActivity(activityChangeIntent);
            }
        });
        ...
        Btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent activityChangeIntent = new Intent(registrationform.this,loginActivity.class);
                registrationform.this.startActivity(activityChangeIntent);
            }
        });*/
